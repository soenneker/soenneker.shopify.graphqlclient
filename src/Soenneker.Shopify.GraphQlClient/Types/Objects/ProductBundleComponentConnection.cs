...
/// </summary>
public sealed partial class ProductBundleComponentConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ProductBundleComponentEdge> Edges { get; init; } = [];
    ...
    public List<ProductBundleComponent> Nodes { get; init; } = [];
