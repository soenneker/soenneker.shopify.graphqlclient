...
/// </summary>
public sealed partial class MetafieldDefinitionConstraintValueConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<MetafieldDefinitionConstraintValueEdge> Edges { get; init; } = [];
    ...
    public List<MetafieldDefinitionConstraintValue> Nodes { get; init; } = [];
