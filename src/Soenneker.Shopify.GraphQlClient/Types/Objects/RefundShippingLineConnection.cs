...
/// </summary>
public sealed partial class RefundShippingLineConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<RefundShippingLineEdge> Edges { get; init; } = [];
    ...
    public List<RefundShippingLine> Nodes { get; init; } = [];
