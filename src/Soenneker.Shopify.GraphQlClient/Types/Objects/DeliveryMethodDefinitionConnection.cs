...
/// </summary>
public sealed partial class DeliveryMethodDefinitionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DeliveryMethodDefinitionEdge> Edges { get; init; } = [];
    ...
    public List<DeliveryMethodDefinition> Nodes { get; init; } = [];
