...
/// </summary>
public sealed partial class GiftCardTransactionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<GiftCardTransactionEdge> Edges { get; init; } = [];
    ...
    public List<GiftCardTransaction> Nodes { get; init; } = [];
