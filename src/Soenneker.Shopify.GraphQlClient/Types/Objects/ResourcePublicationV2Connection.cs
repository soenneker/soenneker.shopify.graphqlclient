...
/// </summary>
public sealed partial class ResourcePublicationV2Connection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ResourcePublicationV2Edge> Edges { get; init; } = [];
    ...
    public List<ResourcePublicationV2> Nodes { get; init; } = [];
