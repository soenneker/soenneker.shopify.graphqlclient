...
/// </summary>
public sealed partial class StoreCreditAccountConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<StoreCreditAccountEdge> Edges { get; init; } = [];
    ...
    public List<StoreCreditAccount> Nodes { get; init; } = [];
