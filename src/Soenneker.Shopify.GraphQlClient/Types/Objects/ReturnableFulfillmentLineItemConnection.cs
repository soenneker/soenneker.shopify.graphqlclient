...
/// </summary>
public sealed partial class ReturnableFulfillmentLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ReturnableFulfillmentLineItemEdge> Edges { get; init; } = [];
    ...
    public List<ReturnableFulfillmentLineItem> Nodes { get; init; } = [];
