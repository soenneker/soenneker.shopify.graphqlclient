...
/// </summary>
public sealed partial class DeliveryLocationGroupZoneConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DeliveryLocationGroupZoneEdge> Edges { get; init; } = [];
    ...
    public List<DeliveryLocationGroupZone> Nodes { get; init; } = [];
