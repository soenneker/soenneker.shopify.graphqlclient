...
/// </summary>
public sealed partial class CollectionPublicationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CollectionPublicationEdge> Edges { get; init; } = [];
    ...
    public List<CollectionPublication> Nodes { get; init; } = [];
