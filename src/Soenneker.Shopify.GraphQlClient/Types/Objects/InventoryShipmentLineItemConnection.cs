...
/// </summary>
public sealed partial class InventoryShipmentLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<InventoryShipmentLineItemEdge> Edges { get; init; } = [];
    ...
    public List<InventoryShipmentLineItem> Nodes { get; init; } = [];
