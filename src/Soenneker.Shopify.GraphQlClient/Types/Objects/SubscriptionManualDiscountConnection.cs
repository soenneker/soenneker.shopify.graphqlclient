...
/// </summary>
public sealed partial class SubscriptionManualDiscountConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<SubscriptionManualDiscountEdge> Edges { get; init; } = [];
    ...
    public List<SubscriptionManualDiscount> Nodes { get; init; } = [];
