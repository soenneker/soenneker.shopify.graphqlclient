...
/// </summary>
public sealed partial class DiscountAllocationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DiscountAllocationEdge> Edges { get; init; } = [];
    ...
    public List<DiscountAllocation> Nodes { get; init; } = [];
