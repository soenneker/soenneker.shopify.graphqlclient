...
/// </summary>
public sealed partial class DeliveryPromiseParticipantConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DeliveryPromiseParticipantEdge> Edges { get; init; } = [];
    ...
    public List<DeliveryPromiseParticipant> Nodes { get; init; } = [];
