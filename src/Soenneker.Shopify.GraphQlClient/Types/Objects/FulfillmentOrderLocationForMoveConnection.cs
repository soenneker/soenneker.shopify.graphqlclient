...
/// </summary>
public sealed partial class FulfillmentOrderLocationForMoveConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<FulfillmentOrderLocationForMoveEdge> Edges { get; init; } = [];
    ...
    public List<FulfillmentOrderLocationForMove> Nodes { get; init; } = [];
