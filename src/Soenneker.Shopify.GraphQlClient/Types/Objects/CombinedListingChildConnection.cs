...
/// </summary>
public sealed partial class CombinedListingChildConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CombinedListingChildEdge> Edges { get; init; } = [];
    ...
    public List<CombinedListingChild> Nodes { get; init; } = [];
