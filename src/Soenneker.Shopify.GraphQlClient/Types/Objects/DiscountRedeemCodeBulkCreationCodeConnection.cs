...
/// </summary>
public sealed partial class DiscountRedeemCodeBulkCreationCodeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DiscountRedeemCodeBulkCreationCodeEdge> Edges { get; init; } = [];
    ...
    public List<DiscountRedeemCodeBulkCreationCode> Nodes { get; init; } = [];
