...
/// </summary>
public sealed partial class PaymentMandateResourceConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<PaymentMandateResourceEdge> Edges { get; init; } = [];
    ...
    public List<PaymentMandateResource> Nodes { get; init; } = [];
