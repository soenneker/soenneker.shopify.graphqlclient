...
/// </summary>
public sealed partial class DiscountApplicationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DiscountApplicationEdge> Edges { get; init; } = [];
    ...
    public List<DiscountApplication> Nodes { get; init; } = [];
