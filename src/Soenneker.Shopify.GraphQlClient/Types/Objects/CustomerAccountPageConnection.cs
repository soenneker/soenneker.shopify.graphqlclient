...
/// </summary>
public sealed partial class CustomerAccountPageConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CustomerAccountPageEdge> Edges { get; init; } = [];
    ...
    public List<CustomerAccountPage> Nodes { get; init; } = [];
