...
/// </summary>
public sealed partial class OnlineStoreThemeFileConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<OnlineStoreThemeFileEdge> Edges { get; init; } = [];
    ...
    public List<OnlineStoreThemeFile> Nodes { get; init; } = [];
    ...
    public List<OnlineStoreThemeFileReadResult> UserErrors { get; init; } = [];
