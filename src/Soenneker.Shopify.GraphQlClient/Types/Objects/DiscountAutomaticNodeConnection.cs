...
/// </summary>
public sealed partial class DiscountAutomaticNodeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DiscountAutomaticNodeEdge> Edges { get; init; } = [];
    ...
    public List<DiscountAutomaticNode> Nodes { get; init; } = [];
