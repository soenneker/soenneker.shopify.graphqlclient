...
/// </summary>
public sealed partial class CashTrackingAdjustmentConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CashTrackingAdjustmentEdge> Edges { get; init; } = [];
    ...
    public List<CashTrackingAdjustment> Nodes { get; init; } = [];
