...
/// </summary>
public sealed partial class CompanyContactRoleAssignmentConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CompanyContactRoleAssignmentEdge> Edges { get; init; } = [];
    ...
    public List<CompanyContactRoleAssignment> Nodes { get; init; } = [];
