...
/// </summary>
public sealed partial class AbandonedCheckoutLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<AbandonedCheckoutLineItemEdge> Edges { get; init; } = [];
    ...
    public List<AbandonedCheckoutLineItem> Nodes { get; init; } = [];
