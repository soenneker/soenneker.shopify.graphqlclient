...
/// </summary>
public sealed partial class CalculatedDiscountApplicationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CalculatedDiscountApplicationEdge> Edges { get; init; } = [];
    ...
    public List<CalculatedDiscountApplication> Nodes { get; init; } = [];
