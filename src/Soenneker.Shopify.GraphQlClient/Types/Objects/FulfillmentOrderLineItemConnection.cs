...
/// </summary>
public sealed partial class FulfillmentOrderLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<FulfillmentOrderLineItemEdge> Edges { get; init; } = [];
    ...
    public List<FulfillmentOrderLineItem> Nodes { get; init; } = [];
