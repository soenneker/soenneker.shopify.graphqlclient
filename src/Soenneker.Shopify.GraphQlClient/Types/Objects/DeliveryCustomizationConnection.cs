...
/// </summary>
public sealed partial class DeliveryCustomizationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DeliveryCustomizationEdge> Edges { get; init; } = [];
    ...
    public List<DeliveryCustomization> Nodes { get; init; } = [];
