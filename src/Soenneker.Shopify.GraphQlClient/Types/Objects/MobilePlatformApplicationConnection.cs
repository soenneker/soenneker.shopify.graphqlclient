...
/// </summary>
public sealed partial class MobilePlatformApplicationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<MobilePlatformApplicationEdge> Edges { get; init; } = [];
    ...
    public List<MobilePlatformApplication> Nodes { get; init; } = [];
