...
/// </summary>
public sealed partial class StandardMetafieldDefinitionTemplateConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<StandardMetafieldDefinitionTemplateEdge> Edges { get; init; } = [];
    ...
    public List<StandardMetafieldDefinitionTemplate> Nodes { get; init; } = [];
