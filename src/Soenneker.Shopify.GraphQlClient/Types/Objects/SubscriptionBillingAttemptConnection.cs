...
/// </summary>
public sealed partial class SubscriptionBillingAttemptConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<SubscriptionBillingAttemptEdge> Edges { get; init; } = [];
    ...
    public List<SubscriptionBillingAttempt> Nodes { get; init; } = [];
