...
/// </summary>
public sealed partial class TaxonomyCategoryAttributeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<TaxonomyCategoryAttributeEdge> Edges { get; init; } = [];
    ...
    public List<TaxonomyCategoryAttribute> Nodes { get; init; } = [];
