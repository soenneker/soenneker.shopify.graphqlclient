...
/// </summary>
public sealed partial class PriceRuleDiscountCodeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<PriceRuleDiscountCodeEdge> Edges { get; init; } = [];
    ...
    public List<PriceRuleDiscountCode> Nodes { get; init; } = [];
