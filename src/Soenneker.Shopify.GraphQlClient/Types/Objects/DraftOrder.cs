...
/// </summary>
public sealed partial class DraftOrder : CommentEventSubject, HasEvents, HasLocalizationExtensions, HasLocalizedFields, HasMetafields, LegacyInteroperability, Navigable, Node
{
    /// <summary>
    ...
    public string InvoiceEmailTemplateSubject { get; init; } = null!;

    /// <summary>
    /// The date and time when the invoice was last emailed to the customer.
    /// </summary>
    [JsonPropertyName("invoiceSentAt")]
    public DateTimeOffset? InvoiceSentAt { get; init; }
    ...
    public DraftOrderLineItemConnection LineItems { get; init; } = null!;
    ...
    public DraftOrderStatus Status { get; init; }
