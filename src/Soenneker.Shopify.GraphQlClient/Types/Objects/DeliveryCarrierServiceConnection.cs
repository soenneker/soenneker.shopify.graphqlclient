...
/// </summary>
public sealed partial class DeliveryCarrierServiceConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DeliveryCarrierServiceEdge> Edges { get; init; } = [];
    ...
    public List<DeliveryCarrierService> Nodes { get; init; } = [];
