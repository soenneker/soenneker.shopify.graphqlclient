...
/// </summary>
public sealed partial class FulfillmentLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<FulfillmentLineItemEdge> Edges { get; init; } = [];
    ...
    public List<FulfillmentLineItem> Nodes { get; init; } = [];
