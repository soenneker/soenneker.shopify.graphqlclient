...
/// </summary>
public sealed partial class DiscountRedeemCodeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DiscountRedeemCodeEdge> Edges { get; init; } = [];
    ...
    public List<DiscountRedeemCode> Nodes { get; init; } = [];
