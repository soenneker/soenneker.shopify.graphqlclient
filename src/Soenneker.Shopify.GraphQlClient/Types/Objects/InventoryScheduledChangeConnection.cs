...
/// </summary>
public sealed partial class InventoryScheduledChangeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<InventoryScheduledChangeEdge> Edges { get; init; } = [];
    ...
    public List<InventoryScheduledChange> Nodes { get; init; } = [];
