...
/// </summary>
public sealed partial class FinancialSummaryDiscountAllocation
{
    /// <summary>
    ...
    public MoneyBag ApproximateAllocatedAmountPerItem { get; init; } = null!;

    /// <summary>
    /// The discount application that the allocated amount originated from.
    /// </summary>
    [JsonPropertyName("discountApplication")]
    public FinancialSummaryDiscountApplication DiscountApplication { get; init; } = null!;
