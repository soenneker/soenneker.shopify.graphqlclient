...
/// </summary>
public sealed partial class LocalizationExtensionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<LocalizationExtensionEdge> Edges { get; init; } = [];
    ...
    public List<LocalizationExtension> Nodes { get; init; } = [];
