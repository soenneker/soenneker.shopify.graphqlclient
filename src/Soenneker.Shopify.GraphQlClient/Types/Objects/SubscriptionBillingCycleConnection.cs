...
/// </summary>
public sealed partial class SubscriptionBillingCycleConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<SubscriptionBillingCycleEdge> Edges { get; init; } = [];
    ...
    public List<SubscriptionBillingCycle> Nodes { get; init; } = [];
