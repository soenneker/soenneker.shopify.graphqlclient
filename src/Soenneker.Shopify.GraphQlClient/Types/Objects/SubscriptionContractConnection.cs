...
/// </summary>
public sealed partial class SubscriptionContractConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<SubscriptionContractEdge> Edges { get; init; } = [];
    ...
    public List<SubscriptionContract> Nodes { get; init; } = [];
