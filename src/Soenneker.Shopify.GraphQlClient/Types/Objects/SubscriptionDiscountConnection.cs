...
/// </summary>
public sealed partial class SubscriptionDiscountConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<SubscriptionDiscountEdge> Edges { get; init; } = [];
    ...
    public List<SubscriptionDiscount> Nodes { get; init; } = [];
