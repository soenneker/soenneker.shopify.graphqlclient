...
/// </summary>
public sealed partial class ReverseFulfillmentOrderConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ReverseFulfillmentOrderEdge> Edges { get; init; } = [];
    ...
    public List<ReverseFulfillmentOrder> Nodes { get; init; } = [];
