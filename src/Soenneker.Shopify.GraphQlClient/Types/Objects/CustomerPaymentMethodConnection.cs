...
/// </summary>
public sealed partial class CustomerPaymentMethodConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CustomerPaymentMethodEdge> Edges { get; init; } = [];
    ...
    public List<CustomerPaymentMethod> Nodes { get; init; } = [];
