...
/// </summary>
public sealed partial class MetaobjectDefinitionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<MetaobjectDefinitionEdge> Edges { get; init; } = [];
    ...
    public List<MetaobjectDefinition> Nodes { get; init; } = [];
