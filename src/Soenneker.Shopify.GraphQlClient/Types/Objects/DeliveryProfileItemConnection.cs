...
/// </summary>
public sealed partial class DeliveryProfileItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DeliveryProfileItemEdge> Edges { get; init; } = [];
    ...
    public List<DeliveryProfileItem> Nodes { get; init; } = [];
