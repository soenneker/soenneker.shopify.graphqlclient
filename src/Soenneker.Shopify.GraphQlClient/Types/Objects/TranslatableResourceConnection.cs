...
/// </summary>
public sealed partial class TranslatableResourceConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<TranslatableResourceEdge> Edges { get; init; } = [];
    ...
    public List<TranslatableResource> Nodes { get; init; } = [];
