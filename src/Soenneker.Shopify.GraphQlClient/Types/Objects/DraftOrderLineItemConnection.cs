...
/// </summary>
public sealed partial class DraftOrderLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<DraftOrderLineItemEdge> Edges { get; init; } = [];
    ...
    public List<DraftOrderLineItem> Nodes { get; init; } = [];
