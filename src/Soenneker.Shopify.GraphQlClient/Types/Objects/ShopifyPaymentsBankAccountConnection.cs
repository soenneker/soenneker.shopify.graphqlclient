...
/// </summary>
public sealed partial class ShopifyPaymentsBankAccountConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ShopifyPaymentsBankAccountEdge> Edges { get; init; } = [];
    ...
    public List<ShopifyPaymentsBankAccount> Nodes { get; init; } = [];
