...
/// </summary>
public sealed partial class MetafieldReferenceConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<MetafieldReferenceEdge> Edges { get; init; } = [];
    ...
    public List<MetafieldReference> Nodes { get; init; } = [];
