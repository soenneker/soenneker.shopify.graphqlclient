...
/// </summary>
public sealed partial class MarketLocalizableResourceConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<MarketLocalizableResourceEdge> Edges { get; init; } = [];
    ...
    public List<MarketLocalizableResource> Nodes { get; init; } = [];
