...
/// </summary>
public sealed partial class PaymentCustomizationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<PaymentCustomizationEdge> Edges { get; init; } = [];
    ...
    public List<PaymentCustomization> Nodes { get; init; } = [];
