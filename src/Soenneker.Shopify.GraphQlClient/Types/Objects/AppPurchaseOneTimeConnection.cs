...
/// </summary>
public sealed partial class AppPurchaseOneTimeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<AppPurchaseOneTimeEdge> Edges { get; init; } = [];
    ...
    public List<AppPurchaseOneTime> Nodes { get; init; } = [];
