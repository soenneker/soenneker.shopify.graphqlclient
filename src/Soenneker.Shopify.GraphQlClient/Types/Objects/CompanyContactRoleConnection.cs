...
/// </summary>
public sealed partial class CompanyContactRoleConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CompanyContactRoleEdge> Edges { get; init; } = [];
    ...
    public List<CompanyContactRole> Nodes { get; init; } = [];
