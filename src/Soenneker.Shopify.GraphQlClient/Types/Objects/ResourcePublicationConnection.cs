...
/// </summary>
public sealed partial class ResourcePublicationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ResourcePublicationEdge> Edges { get; init; } = [];
    ...
    public List<ResourcePublication> Nodes { get; init; } = [];
