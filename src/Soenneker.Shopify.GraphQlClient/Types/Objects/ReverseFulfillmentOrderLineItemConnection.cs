...
/// </summary>
public sealed partial class ReverseFulfillmentOrderLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ReverseFulfillmentOrderLineItemEdge> Edges { get; init; } = [];
    ...
    public List<ReverseFulfillmentOrderLineItem> Nodes { get; init; } = [];
