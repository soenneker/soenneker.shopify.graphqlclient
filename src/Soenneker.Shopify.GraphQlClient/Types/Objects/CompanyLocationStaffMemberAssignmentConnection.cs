...
/// </summary>
public sealed partial class CompanyLocationStaffMemberAssignmentConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CompanyLocationStaffMemberAssignmentEdge> Edges { get; init; } = [];
    ...
    public List<CompanyLocationStaffMemberAssignment> Nodes { get; init; } = [];
