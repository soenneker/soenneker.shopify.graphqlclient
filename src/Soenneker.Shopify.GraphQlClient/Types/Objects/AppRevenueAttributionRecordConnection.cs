...
/// </summary>
public sealed partial class AppRevenueAttributionRecordConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<AppRevenueAttributionRecordEdge> Edges { get; init; } = [];
    ...
    public List<AppRevenueAttributionRecord> Nodes { get; init; } = [];
