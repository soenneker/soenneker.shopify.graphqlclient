...
/// </summary>
public sealed partial class StoreCreditAccountTransactionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<StoreCreditAccountTransactionEdge> Edges { get; init; } = [];
    ...
    public List<StoreCreditAccountTransaction> Nodes { get; init; } = [];
