...
/// </summary>
public sealed partial class WebhookSubscriptionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<WebhookSubscriptionEdge> Edges { get; init; } = [];
    ...
    public List<WebhookSubscription> Nodes { get; init; } = [];
