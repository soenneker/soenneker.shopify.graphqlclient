...
/// </summary>
public sealed partial class ShopifyPaymentsBalanceTransactionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ShopifyPaymentsBalanceTransactionEdge> Edges { get; init; } = [];
    ...
    public List<ShopifyPaymentsBalanceTransaction> Nodes { get; init; } = [];
