...
/// </summary>
public sealed partial class ProductPublicationConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ProductPublicationEdge> Edges { get; init; } = [];
    ...
    public List<ProductPublication> Nodes { get; init; } = [];
