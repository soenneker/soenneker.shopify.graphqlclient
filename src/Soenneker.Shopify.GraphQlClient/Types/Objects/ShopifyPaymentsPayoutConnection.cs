...
/// </summary>
public sealed partial class ShopifyPaymentsPayoutConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ShopifyPaymentsPayoutEdge> Edges { get; init; } = [];
    ...
    public List<ShopifyPaymentsPayout> Nodes { get; init; } = [];
