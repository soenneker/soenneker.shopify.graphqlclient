...
/// </summary>
public sealed partial class FulfillmentOrderMerchantRequestConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<FulfillmentOrderMerchantRequestEdge> Edges { get; init; } = [];
    ...
    public List<FulfillmentOrderMerchantRequest> Nodes { get; init; } = [];
