...
/// </summary>
public sealed partial class ShopifyPaymentsDisputeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ShopifyPaymentsDisputeEdge> Edges { get; init; } = [];
    ...
    public List<ShopifyPaymentsDispute> Nodes { get; init; } = [];
