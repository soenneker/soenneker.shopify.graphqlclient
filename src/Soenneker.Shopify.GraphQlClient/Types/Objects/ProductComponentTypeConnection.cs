...
/// </summary>
public sealed partial class ProductComponentTypeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ProductComponentTypeEdge> Edges { get; init; } = [];
    ...
    public List<ProductComponentType> Nodes { get; init; } = [];
