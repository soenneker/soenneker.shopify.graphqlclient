...
/// </summary>
public sealed partial class ReturnReasonDefinitionConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ReturnReasonDefinitionEdge> Edges { get; init; } = [];
    ...
    public List<ReturnReasonDefinition> Nodes { get; init; } = [];
