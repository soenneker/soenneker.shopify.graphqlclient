...
/// </summary>
public sealed partial class ReverseDeliveryLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ReverseDeliveryLineItemEdge> Edges { get; init; } = [];
    ...
    public List<ReverseDeliveryLineItem> Nodes { get; init; } = [];
