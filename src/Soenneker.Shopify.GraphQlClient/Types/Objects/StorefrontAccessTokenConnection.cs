...
/// </summary>
public sealed partial class StorefrontAccessTokenConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<StorefrontAccessTokenEdge> Edges { get; init; } = [];
    ...
    public List<StorefrontAccessToken> Nodes { get; init; } = [];
