...
/// </summary>
public sealed partial class ProductVariantPricePairConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ProductVariantPricePairEdge> Edges { get; init; } = [];
    ...
    public List<ProductVariantPricePair> Nodes { get; init; } = [];
