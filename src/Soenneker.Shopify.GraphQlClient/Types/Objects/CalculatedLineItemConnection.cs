...
/// </summary>
public sealed partial class CalculatedLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CalculatedLineItemEdge> Edges { get; init; } = [];
    ...
    public List<CalculatedLineItem> Nodes { get; init; } = [];
