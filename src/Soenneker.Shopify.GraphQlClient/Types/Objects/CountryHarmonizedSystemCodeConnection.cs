...
/// </summary>
public sealed partial class CountryHarmonizedSystemCodeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<CountryHarmonizedSystemCodeEdge> Edges { get; init; } = [];
    ...
    public List<CountryHarmonizedSystemCode> Nodes { get; init; } = [];
