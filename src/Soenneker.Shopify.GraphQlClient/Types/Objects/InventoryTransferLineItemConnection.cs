...
/// </summary>
public sealed partial class InventoryTransferLineItemConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<InventoryTransferLineItemEdge> Edges { get; init; } = [];
    ...
    public List<InventoryTransferLineItem> Nodes { get; init; } = [];
