...
/// </summary>
public sealed partial class QuantityPriceBreakConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<QuantityPriceBreakEdge> Edges { get; init; } = [];
    ...
    public List<QuantityPriceBreak> Nodes { get; init; } = [];
