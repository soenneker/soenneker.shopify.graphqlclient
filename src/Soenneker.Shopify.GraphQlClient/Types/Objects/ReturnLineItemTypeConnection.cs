...
/// </summary>
public sealed partial class ReturnLineItemTypeConnection
{
    /// <summary>
    /// The connection between the node and its parent. Each edge contains a minimum of the edge's cursor and the node.
    /// </summary>
    [JsonPropertyName("edges")]
    public List<ReturnLineItemTypeEdge> Edges { get; init; } = [];
    ...
    public List<ReturnLineItemType> Nodes { get; init; } = [];
