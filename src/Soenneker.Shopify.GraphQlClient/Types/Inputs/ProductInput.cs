...
/// </summary>
public sealed partial class ProductInput
{
    /// <summary>
    ...
    public List<string>? CollectionsToLeave { get; init; }
    ...
    public List<ProductPublicationInput>? Publications { get; init; }
    ...
    /// Only products with an active status can be published.
    /// </summary>
    [JsonPropertyName("publishOn")]
    public DateTimeOffset? PublishOn { get; init; }
