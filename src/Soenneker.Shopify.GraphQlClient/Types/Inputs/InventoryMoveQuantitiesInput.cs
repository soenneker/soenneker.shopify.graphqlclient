...
/// </summary>
public sealed partial class InventoryMoveQuantitiesInput
{
    /// <summary>
    ...
    public string ReferenceDocumentUri { get; init; } = null!;

    /// <summary>
    /// The quantity changes of items at locations to be made.
    /// </summary>
    [JsonPropertyName("changes")]
    public List<InventoryMoveQuantityChange> Changes { get; init; } = [];
