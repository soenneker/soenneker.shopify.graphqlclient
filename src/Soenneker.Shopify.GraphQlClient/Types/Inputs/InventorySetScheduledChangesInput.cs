...
/// </summary>
public sealed partial class InventorySetScheduledChangesInput
{
    /// <summary>
    ...
    public List<InventoryScheduledChangeItemInput> Items { get; init; } = [];
    ...
    public Uri ReferenceDocumentUri { get; init; } = null!;
