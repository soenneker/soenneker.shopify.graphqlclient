...
/// </summary>
public sealed partial class ProductBundleConsolidatedOptionSelectionInput
{
    /// <summary>
    ...
    public List<ProductBundleConsolidatedOptionComponentInput> Components { get; init; } = [];
