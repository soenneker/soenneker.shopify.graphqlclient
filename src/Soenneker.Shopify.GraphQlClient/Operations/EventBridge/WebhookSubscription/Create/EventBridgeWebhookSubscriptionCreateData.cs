...
/// <summary>
/// Response data wrapper for the 'eventBridgeWebhookSubscriptionCreate' GraphQL operation.
/// </summary>
public sealed partial class EventBridgeWebhookSubscriptionCreateData
{
    /// <summary>
